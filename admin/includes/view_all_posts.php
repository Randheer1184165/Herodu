...
$query = "INSERT INTO heroku_597cf2e5c9cb274.posts (post_category_id, post_title, post_author, post_user, post_date,post_image, post_content, post_tags,post_status)";
...
//echo "<td><a onClick=\"javascript: return confirm('Are you you want to delete'); \" href='posts.php?delete={$post_id}'>Delete</a></td>";
...
-->                       
     ...
     $query ="DELETE FROM heroku_597cf2e5c9cb274.posts WHERE post_id ={$the_post_id}";
     ...
     $query ="UPDATE heroku_597cf2e5c9cb274.posts SET post_views_count =0 WHERE post_id={$the_post_id}";
