...
<!--  MAKING DYNAMIC DATA 23 to count automatically
...
<div class='huge'>23</div>   -->
            ...
            <a href="categories.php">
                ...
                <!-- using JAVAscript create <div mention class and copy script to script first paste in ther admin header then copy code from google before  </head/.row -->
<?php
...
<?php
$element_text =['All post','Active Posts', 'Draft Posts','pending comments', 'Comments', 'Users','subscribers', 'Categories'];
$element_count = [$post_published_counts,$post_counts,$post_draft_counts,$unapproved_comment_counts,$comment_counts,$user_counts,$subscriber_counts,$category_counts];
for ($i = 0; $i < 6; $i++) {
...
?>      
      //    ['posts', 1000,] making above dynamic
    ...
    <!---mention all javascript in this section should be define <div id="top_x_div" style="width: 800px; height: 600px;"></div>-->
