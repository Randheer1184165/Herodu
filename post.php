...
$view_query ="UPDATE heroku_597cf2e5c9cb274.posts SET post_views_count =post_views_count +1 WHERE post_id=$the_post_id ";
...
$query = "SELECT * FROM heroku_597cf2e5c9cb274.posts WHERE post_id= {$the_post_id} AND post_status = 'published' ";
...
////we are modyfing our code
//$query = "SELECT * FROM posts WHERE post_id= {$the_post_id} ";
//$select_all_posts_query= mysqli_query($connection, $query);
//////this above query are workking
...
/* code working but using different methood///      
